@.claude/rules/core-middleware-system.md
@spekn/CLAUDE.md

# Spekn Agent Entrypoint

> Managed by Spekn | Spec generation: —

Apply this context before implementation work.

## Context Source (Static)

- Global canonical context: `./spekn/CLAUDE.md`
- Spekn is the source of truth; refresh exports when specifications change.
...
Read full specifications from `./spekn/CLAUDE.md` and `./spekn/` context directory.
...
- Keep decision context active from start to finish; do not code with stale decision state.
- Escalate conflicts between local files and Spekn-generated context.
