	...
	var Command = (function () {
	  ...
	  _createClass(Command, [{
	    ...
	    value: function execute(store) {
	      ...
	      return (0, _co2.default)((_fx = this.fx).call.apply(_fx, [store.getState()].concat(args))).then(function (payload) {
	        ...
	        return regeneratorRuntime.wrap(function _callee$(_context) {
	          while (1) {
	            switch (_context.prev = _context.next) {
	              case 0:
	                _context.t0 = regeneratorRuntime.keys(this.commands);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Store = (function () {
	  ...
	  _createClass(Store, [{
	    key: 'addSignals',
	    value: function addSignals(signals) {
	      var _this = this;

	      signals = [].concat(signals);
	      signals.forEach(function (signal) {
	        var s = new _signal2.default();
	        _this[signal] = function () {
	    ...
	    value: function updateState(payload) {
	      this.state = _extends({}, state, payload);
	    }
	  }]);
